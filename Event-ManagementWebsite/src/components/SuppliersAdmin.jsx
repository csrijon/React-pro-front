...
const SuppliersAdmin = () => {
  ...
  const handelvideophotographer = async () => {
    try {
      ...
      let response = await fetch("https://react-pro-front.onrender.com/videophotographer", {
        method: "POST",
        body: formdata
      })
  ...
  const addhandeler = async () => {
    ...
    try {
      ...
      let response = await fetch("https://react-pro-front.onrender.com/supplyers", {
        method: "POST",
        body: formData
      })
      let data = await response.json()
  ...
  let popularchange = async () => {
    try {
      ...
      let popresponse = await fetch("https://react-pro-front.onrender.com/popvenue", {
        method: "POST",
        body: formdata
      })
  ...
  let trandingchange = async () => {
    try {
      ...
      const response = await fetch("https://react-pro-front.onrender.com/trending", {
        method: "POST",
        body: formdata
      })
  ...
  let deletesupplycard = async (id) => {
    console.log(id)
    let senddelete = await fetch(`https://react-pro-front.onrender.com/deletesupply/${id}`, {
      method: "DELETE"
    })
  ...
  let removetrendcard = async (id) => {
    let removetrend = await fetch(`https://react-pro-front.onrender.com/apitrending/${id}`, {
      method: "DELETE"
    })
  ...
  let removepopularcard = async (id) => {
    let removeidsend = await fetch(`https://react-pro-front.onrender.com/removepopular/${id}`, {
      method: "DELETE"
    })
  ...
  let removephotovideo = async (id) => {
    let removepv = await fetch(`https://react-pro-front.onrender.com/pvdeleted/${id}`,{
      method:"DELETE"
    })
  ...
  useEffect(() => {
    let fetchsupplydata = async () => {
      let getsupplydata = await fetch("https://react-pro-front.onrender.com/supplyers")
    ...
    let fetchtrenddata = async () => {
      let getrenddata = await fetch("https://react-pro-front.onrender.com/api/fetchtreding")
    ...
    let fetchpopulardata = async () => {
      let getpopulardata = await fetch("https://react-pro-front.onrender.com/api/fetchvenu")
    ...
    let fetchphotovideo = async () => {
      let getphotovideo = await fetch("https://react-pro-front.onrender.com/apivideophotographer")
