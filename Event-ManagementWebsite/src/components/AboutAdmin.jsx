...
const AboutAdmin = () => {
  ...
  let handleMainAdd = async () => {
    try {
      ...
      let response = await fetch("https://react-pro-front.onrender.com/addaboutmain", {
        method: "POST",
        body: formData
  ...
  const handleStatsAdd = async () => {
    ...
    try {
      let response = await fetch("https://react-pro-front.onrender.com/addaboutstats", {
        method: "POST",
        headers: {
  ...
  const handleBlock1Add = async () => {
    try {
      ...
      let reponse = await fetch("https://react-pro-front.onrender.com/addaboutblock1", {
        method: "POST",
  ...
  const handleBlock2Add = async () => {
    try {
      ...
      let response = await fetch("https://react-pro-front.onrender.com/addaboutblock2", {
        method: "POST",
        body: formdata
      });
      let data = await response.json();
