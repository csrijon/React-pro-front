...
const AboutAdmin = () => {
  ...
  let handleMainAdd = async () => {
    try {
      ...
      let response = await fetch("https://backend-ofevent.onrender.com/addaboutmain", {
        method: "POST",
        body: formData
  ...
  const handleStatsAdd = async () => {
    ...
    try {
      let response = await fetch("https://backend-ofevent.onrender.com/addaboutstats", {
        method: "POST",
        headers: {
  ...
  const handleBlock1Add = async () => {
    try {
      ...
      let reponse = await fetch("https://backend-ofevent.onrender.com/addaboutblock1", {
        method: "POST",
  ...
  const handleBlock2Add = async () => {
    try {
      ...
      let response = await fetch("https://backend-ofevent.onrender.com/addaboutblock2", {
        method: "POST",
        body: formdata
      });
      let data = await response.json();
