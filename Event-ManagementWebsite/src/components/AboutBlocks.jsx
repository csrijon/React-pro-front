...
const AboutBlocks = () => {
  ...
  useEffect(() => {
    let fetchaboutblocks1 = async () => {
      try {
        let response = await fetch("https://backendof-event.onrender.com/api/fetchaboutblock1");
    ...
    let fetchaboutblock2 = async () => {
      try {
        let response = await fetch("https://backendof-event.onrender.com/api/fetchaboutblock2");
        let data = await response.json();
